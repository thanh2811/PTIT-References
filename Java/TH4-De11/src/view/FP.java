...
public class FP extends javax.swing.JPanel {
    ...
    public FP() {
        initComponents();
        t = s = false;
        String[] col = {"Ma","Kieu","Muc gia","So phong con" };
    ...
    private void initComponents() {
        ...
        jLabel4.setText("So phong con lai");

        jTextField1.setEditable(false);

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Don", "Doi", "VIP" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        List<Phong> l = getP();
        if(l.size()>0)
            Phong.setSma(l.get(l.size()-1).getMa() + 1);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(t){
            ...
            tm.addRow((new Phong(ma, kieu, muc, sl)).toObject());
        }
        buttonTrue();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        List<Phong> l = IOFile.docra(file);
        tm.setRowCount(0);
        for(Phong i : l) tm.addRow(i.toObject());
