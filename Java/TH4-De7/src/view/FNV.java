...
DefaultTableModel tm;
    ...
    public FNV() {
        initComponents();
        t= s = false;
        String[] cols = {"Ma","Ten","Dia chi","Chuyen mon"};
...
//        int kp = Integer.parseInt(tm.getValueAt(i, 3).toString());
        l.add(new Nvien(ma, ten, kieu, kp));
    }
    return l;
}
    /**
...
//            int kp  = Integer.parseInt(jTextField3.getText());
            String kieu = jTextField3.getText();
            String kp = jTextField4.getText();

            tm.addRow((new Nvien(ma, ten, kieu, kp)).toObject());
        }
        if(s){
            s  = false;
