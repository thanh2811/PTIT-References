...
public class FormKH extends javax.swing.JPanel {
    ...
    public FormKH() {
        initComponents();
        String[] cols = {"Ma","Ten KH","DC","SDT"};
        tm = new DefaultTableModel(cols,0);
        jTable1.setModel(tm);
        buttonTrue();
        t = s = false;
        file = "src/control/kh.txt";
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ha Noi", "Nam Dinh", "Thai Binh", "TP HCM", "Quang Ninh", "Hai Phong", "Da Nang", "Nghe An", "Hai Duong" }));
    ...
    public List<KHang> getKH(){
        ...
        for (int i = 0; i < tm.getRowCount(); i++) {
            ...
            l.add(new KHang(ma, ten, loai, gia));
    ...
    private void capnhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_capnhatActionPerformed
        ...
        if(t){
            ...
            KHang m = new KHang(ma, ten, loai, gai);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        tm.setRowCount(0);
        List<KHang> list = IOFile.doc(file);
        for(KHang i : list){
