 ...
 * @author Pham Thanh
 */
public class FTbi extends javax.swing.JPanel {

    /**
     * Creates new form FTbi
     */
    DefaultTableModel tm;
    String file = "src/control/tb.dat";
    boolean t,s;
    public FTbi() {
        initComponents();
        t= s = false;
        String[] cols = {"Ma","Ten tb","Xuat xu","Nam sx"};
    ...
    public List<TBi> getTB(){
        List<TBi> l = new ArrayList<>();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        List<TBi> l = getTB();
        if(l.size()>0)
            TBi.setSma(l.get(l.size()-1).getMa()+1);
//        else if(l.size()==0)
//           {
//               l = IOFile.doc(file);
//            TBi.setSma(l.get(l.size()-1).getMa()+1);
//        }
        jTextField1.setText(TBi.getSma()+"");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(t){
            ...
            tm.addRow((new TBi(ma, ten, xx, nam)).toObject());
        }
        buttonTrue();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        List<TBi> l = IOFile.doc(file);
        tm.setRowCount(0);
        for(TBi i: l) tm.addRow(i.toObject());
